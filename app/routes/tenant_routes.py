...
def list_tenants():
    ...
    statistics = tenant_service.get_tenant_statistics()
    return render_template('tenant/list.html', tenants=tenants, statistics=statistics)
...
def copy_tenant(tenant_id):
    ...
    try:
        ...
        new_tenant['iscopy'] = True  # 设置为复制租户
        # 创建新租户
